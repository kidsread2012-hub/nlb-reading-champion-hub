...
1. Set the scene briefly (in a room/classroom at a partner venue, as above). Describe the room to the volunteer in the SECOND person ("You are in a bright classroom with low tables arranged in a U-shape...") and describe the child in the THIRD person, giving them a realistic name ("A young child named Emma is sitting on a small chair across from you, and a picture book is ready on the table."). Then ask the volunteer what they would do first.
